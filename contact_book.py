...
def search():
    ...
    while ch1 != 4:
        ...
        if ch1 == 1:
            search1(input("Enter Name : "), 1)
        elif ch1 == 2:
            search1(int(input("Enter Phone Number : ")), 2)
        elif ch1 == 3:
            search1(input("Enter Email Address : "), 3)
        elif ch1 == 4:
            pass
        else:
...
while ch != 3:
    ...
    if ch == 1:
        ...
        sheet.cell(row=r+1, column=1, value=name)
        phone = int(input("Enter Phone Number : "))
        sheet.cell(row=r+1, column=2, value=phone)
        email = input("Enter Email Address : ")
        sheet.cell(row=r+1, column=3, value=email)
        home = input("Enter Home Address : ")
        sheet.cell(row=r+1, column=4, value=home)
        wb.save(filename)
    elif ch == 2:
        search()
    elif ch == 3:
